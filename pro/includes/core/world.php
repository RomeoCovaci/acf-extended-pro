...
class ACFE_World_Data{
    ...
    function __construct(){
        ...
        // Data
        $this->countries = include(ACFE_PATH . 'pro/includes/core/data/countries.php');
        $this->languages = include(ACFE_PATH . 'pro/includes/core/data/languages.php');
        $this->currencies = include(ACFE_PATH . 'pro/includes/core/data/currencies.php');
